...
/**
 * A <code>CouchbaseConnectorLifecycleAdapter</code> is a wrapper around {@link CouchbaseConnector } that adds lifecycle methods to the pojo.
 * 
 */
public class CouchbaseConnectorLifecycleAdapter
    extends CouchbaseConnectorCapabilitiesAdapter
    implements Disposable, Initialisable, Startable, Stoppable
{
    ...
    public void initialise() {
        Logger log = LoggerFactory.getLogger(CouchbaseConnectorLifecycleAdapter.class);
