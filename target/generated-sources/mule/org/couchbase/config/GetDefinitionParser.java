...
import org.couchbase.processors.GetMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public GetDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetMessageProcessor.class.getName());
