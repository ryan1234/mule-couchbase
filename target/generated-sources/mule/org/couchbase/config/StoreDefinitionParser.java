...
import org.couchbase.processors.StoreMessageProcessor;
...
public class StoreDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public StoreDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(StoreMessageProcessor.class.getName());
        ...
        if ((element.getAttribute("value")!= null)&&(!StringUtils.isBlank(element.getAttribute("value")))) {
